...
for shop in (freelancers,antiques,pet_shop) :
    buy_item = input(f"Welcome to {shop['name']}! What do you want to buy: {shop} \n Funds available {purse} \n Type 'exit' to leave.").lower()
